...
#define SOCK_INACTIVE_MAX   (16)	//(PJ_IOQUEUE_MAX_HANDLES - 2)
		      ...
		      int inactive_sock_count)
{
    ...
    //PJ_LOG(3,(THIS_FILE,"...Allocated sockets for sending and receiving."));
	...
	//PJ_LOG(3,(THIS_FILE,"...Allocated inactive sockets"));
