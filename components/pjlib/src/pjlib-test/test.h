...
#define INCLUDE_FIFOBUF_TEST	    0	// GROUP_DATA_STRUCTURE. It takes a bout 5s, So the watch-dog timer was triggered
#define INCLUDE_RBTREE_TEST	    	GROUP_DATA_STRUCTURE
//#define INCLUDE_TIMER_TEST	    GROUP_DATA_STRUCTURE	// It takes so much time and finally it crashes by stack overflow
...
#define INCLUDE_ACTIVESOCK_TEST	    GROUP_NETWORK		// Sometime it only receives 9998 or 9999 packets when it expected 10000 packets
#define INCLUDE_SSLSOCK_TEST	    (PJ_HAS_SSL_SOCK && GROUP_NETWORK)
//#define INCLUDE_IOQUEUE_PERF_TEST   (PJ_HAS_THREADS && GROUP_NETWORK)	// It fails
