...
static int tcp_perf_test(void)
{
    ...
    //PJ_LOG(3,("", "Wait until everything has been sent/received. state1->next_recv_seq:  %u", state1->next_recv_seq));
    ...
    //PJ_LOG(3,("", "Everything was sent/received. state1->next_recv_seq:  %u", state1->next_recv_seq));
